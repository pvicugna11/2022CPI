...
namespace FantomLib
{
    ...
    public static class AndroidPlugin
    {
        ...
        /// </summary>
        /// <param name="packageName">アプリのパッケージ名</param>
        ...
        /// </summary>
        /// <param name="packageName">アプリのパッケージ名</param>
        /// <returns>Version Code / 取得失敗したとき = 0</returns>
        ...
        /// </summary>
        /// <param name="packageName">アプリのパッケージ名</param>
        /// <returns>Version Name / 取得失敗したとき = ""(空文字)</returns>
        ...
        /// <param name="title">根拠の説明ダイアログのタイトル</param>
        /// <param name="message">根拠の説明ダイアログのメッセージ</param>
        /// <param name="callbackGameObject">コールバックするヒエラルキーの GameObject 名</param>
        /// <param name="callbackMethod">コールバックするメソッド名</param>
        /// <param name="style">根拠の説明ダイアログのスタイル（テーマ："android:Theme.DeviceDefault.Dialog.Alert"等）</param>
        ...
        /// <param name="longDuration">表示の長さ： true = 3.5s / false = 2.0s</param>
        ...
        /// <param name="callbackGameObject">コールバックするヒエラルキーの GameObject 名</param>
        /// <param name="callbackMethod">コールバックするメソッド名</param>
        /// <param name="yesCaption">「はい」ボタンの文字列</param>
        /// <param name="yesValue">「はい」のときの戻値</param>
        /// <param name="noCaption">「いいえ」ボタンの文字列</param>
        /// <param name="noValue">「いいえ」のときの戻値</param>
        /// <param name="style">スタイル（テーマ："android:Theme.DeviceDefault.Dialog.Alert", "android:Theme.DeviceDefault.Light.Dialog.Alert"等）</param>
        ...
        /// <param name="callbackGameObject">コールバックするヒエラルキーの GameObject 名</param>
        /// <param name="callbackMethod">コールバックするメソッド名</param>
        /// <param name="okCaption">「OK」ボタンの文字列</param>
        /// <param name="resultValue">「OK」ボタン押下、ダイアログが閉じられたときの戻値</param>
        /// <param name="style">スタイル（テーマ："android:Theme.DeviceDefault.Dialog.Alert", "android:Theme.DeviceDefault.Light.Dialog.Alert"等）</param>
        public static void ShowDialog(string title, string message, string callbackGameObject, string callbackMethod,
        ...
        /// <param name="checkBoxTextColor">チェックボックスのテキストの色（0 で指定なし："AARRGGBB"[Android(Java)の形式]）</param>
        /// <param name="defaultChecked">チェックボックスの初期状態 true=オン</param>
        /// <param name="callbackGameObject">コールバックするヒエラルキーの GameObject 名</param>
        /// <param name="callbackMethod">コールバックするメソッド名</param>
        /// <param name="yesCaption">「はい」ボタンの文字列</param>
        /// <param name="yesValue">「はい」のときの戻値</param>
        ...
        /// <param name="message">メッセージ文字列</param>
        /// <param name="checkBoxText">チェックボックスのテキスト</param>
        /// <param name="checkBoxTextColor">チェックボックスのテキストの色（Color.clear で指定なし[=無色透明ではない]）</param>
        /// <param name="defaultChecked">チェックボックスの初期状態 true=オン</param>
        /// <param name="callbackGameObject">コールバックするヒエラルキーの GameObject 名</param>
        /// <param name="callbackMethod">コールバックするメソッド名</param>
        /// <param name="yesCaption">「はい」ボタンの文字列</param>
        ...
        /// <param name="message">メッセージ文字列</param>
        /// <param name="checkBoxText">チェックボックスのテキスト</param>
        /// <param name="checkBoxTextColor">チェックボックスのテキストの色（"AARRGGBB"[Android(Java)の形式]）（※ただし、0 は「指定しない(通常黒)」となる[=無色透明ではない]）</param>
        /// <param name="defaultChecked">チェックボックスの初期状態 true=オン</param>
        /// <param name="callbackGameObject">コールバックするヒエラルキーの GameObject 名</param>
        /// <param name="callbackMethod">コールバックするメソッド名</param>
        /// <param name="okCaption">「OK」ボタンの文字列</param>
        ...
        /// <param name="message">メッセージ文字列</param>
        /// <param name="checkBoxText">チェックボックスのテキスト</param>
        /// <param name="checkBoxTextColor">チェックボックスのテキストの色（※ただし、Color.clear は「指定しない(通常黒)」となる[=無色透明ではない]）</param>
        /// <param name="defaultChecked">チェックボックスの初期状態 true=オン</param>
        /// <param name="callbackGameObject">コールバックするヒエラルキーの GameObject 名</param>
        /// <param name="callbackMethod">コールバックするメソッド名</param>
        /// <param name="okCaption">「OK」ボタンの文字列</param>
        ...
        /// </summary>
        /// <param name="title">タイトル文字列</param>
        /// <param name="items">選択肢の文字列の配列</param>
        /// <param name="callbackGameObject">コールバックするヒエラルキーの GameObject 名</param>
        /// <param name="callbackMethod">コールバックするメソッド名</param>
        /// <param name="resultIsIndex">戻値をインデクスにする（※ただし文字列型なので変換する必要あり）</param>
        /// <param name="style">スタイル（テーマ："android:Theme.DeviceDefault.Dialog.Alert", "android:Theme.DeviceDefault.Light.Dialog.Alert"等）</param>
        ...
        /// <param name="callbackGameObject">コールバックするヒエラルキーの GameObject 名</param>
        /// <param name="callbackMethod">コールバックするメソッド名</param>
        /// <param name="resultValues">items に対応する結果の配列。選択されたインデクスの要素が戻り値になる</param>
        /// <param name="style">スタイル（テーマ："android:Theme.DeviceDefault.Dialog.Alert", "android:Theme.DeviceDefault.Light.Dialog.Alert"等）</param>
        public static void ShowSelectDialog(string title, string[] items,
        ...
        /// <param name="title">タイトル文字列</param>
        /// <param name="items">選択肢の文字列の配列</param>
        /// <param name="checkedItem">デフォルトの選択のインデクス（0～n-1）</param>
        /// <param name="callbackGameObject">コールバックするヒエラルキーの GameObject 名</param>
        /// <param name="resultCallbackMethod">結果をコールバックするメソッド名</param>
        /// <param name="changeCallbackMethod">値変更（インデクス）のコールバックメソッド名</param>
        /// <param name="cancelCallbackMethod">キャンセル時のコールバックメソッド名</param>
        /// <param name="resultIsIndex">戻値をインデクスにする（※ただし文字列型なので変換する必要あり）</param>
        /// <param name="okCaption">「OK」ボタンの文字列</param>
        /// <param name="cancelCaption">「Cancel」ボタンの文字列</param>
        /// <param name="style">スタイル（テーマ："android:Theme.DeviceDefault.Dialog.Alert", "android:Theme.DeviceDefault.Light.Dialog.Alert"等）</param>
        ...
        /// <param name="checkedItem">デフォルトの選択のインデクス（0～n-1）</param>
        /// <param name="callbackGameObject">コールバックするヒエラルキーの GameObject 名</param>
        /// <param name="resultCallbackMethod">コールバックするメソッド名</param>
        /// <param name="changeCallbackMethod">値変更（インデクス）のコールバックメソッド名</param>
        /// <param name="resultIsIndex">戻値をインデクスにする（※ただし文字列型なので変換する必要あり）</param>
        /// <param name="okCaption">「OK」ボタンの文字列</param>
        /// <param name="cancelCaption">「Cancel」ボタンの文字列</param>
        ...
        /// <param name="title">タイトル文字列</param>
        /// <param name="items">選択肢の文字列の配列</param>
        /// <param name="checkedItems">デフォルトの選択状態の配列（null のとき全て未選択状態）</param>
        /// <param name="callbackGameObject">コールバックするヒエラルキーの GameObject 名</param>
        /// <param name="callbackMethod">コールバックするメソッド名</param>
        /// <param name="changeCallbackMethod">値変更（選択変更）のコールバックメソッド名</param>
        /// <param name="cancelCallbackMethod">キャンセル時のコールバックメソッド名</param>
        /// <param name="resultIsIndex">戻値をインデクスにする（※ただし文字列型なので変換する必要あり）</param>
        /// <param name="okCaption">「OK」ボタンの文字列</param>
        /// <param name="cancelCaption">「Cancel」ボタンの文字列</param>
        ...
        /// <param name="title">タイトル文字列</param>
        /// <param name="items">選択肢の文字列の配列</param>
        /// <param name="checkedItems">デフォルトの選択状態の配列（null のとき未選択状態）</param>
        /// <param name="callbackGameObject">コールバックするヒエラルキーの GameObject 名</param>
        /// <param name="resultCallbackMethod">結果をコールバックするメソッド名</param>
        /// <param name="changeCallbackMethod">値変更（選択変更）のコールバックメソッド名</param>
        /// <param name="cancelCallbackMethod">キャンセル時のコールバックメソッド名</param>
        ...
        /// </summary>
        /// <param name="title">タイトル文字列</param>
        /// <param name="message">メッセージ文字列（空文字("")のとき無し）</param>
        /// <param name="items">アイテムの文字列の配列</param>
        /// <param name="itemKeys">アイテムのキーの配列（null で無し）</param>
        /// <param name="checkedItems">スイッチの初期値の配列（null で全てオフ）</param>
        /// <param name="itemsTextColor">アイテムの文字列の色（0 で指定なし："AARRGGBB"[Android(Java)の形式]）</param>
        /// <param name="callbackGameObject">コールバックするヒエラルキーの GameObject 名</param>
        /// <param name="resultCallbackMethod">結果をコールバックするメソッド名</param>
        /// <param name="changeCallbackMethod">スイッチの押下コールバックメソッド名</param>
        /// <param name="cancelCallbackMethod">キャンセル時のコールバックメソッド名</param>
        /// <param name="okCaption">「OK」ボタンの文字列</param>
        /// <param name="cancelCaption">「Cancel」ボタンの文字列</param>
        /// <param name="style">スタイル（テーマ："android:Theme.DeviceDefault.Dialog.Alert", "android:Theme.DeviceDefault.Light.Dialog.Alert"等）</param>
        ...
        /// <param name="itemKeys">アイテムのキーの配列（null で無し）</param>
        /// <param name="checkedItems">スイッチの初期値の配列（null で全てオフ）</param>
        /// <param name="itemsTextColor">アイテムの文字列の色（Color.clear で指定なし[=無色透明ではない]）</param>
        /// <param name="callbackGameObject">コールバックするヒエラルキーの GameObject 名</param>
        /// <param name="resultCallbackMethod">結果をコールバックするメソッド名</param>
        /// <param name="changeCallbackMethod">スイッチの押下コールバックメソッド名</param>
        /// <param name="cancelCallbackMethod">キャンセル時のコールバックメソッド名</param>
        ...
        /// <param name="message">メッセージ文字列（空文字("")のとき無し）</param>
        /// <param name="items">アイテムの文字列の配列</param>
        /// <param name="itemKeys">各アイテムに対応するキー配列（null のとき無し）</param>
        /// <param name="defValues">初期値の配列（null のとき、すべて 0。整数部分6桁＋小数点以下3桁まで）</param>
        /// <param name="minValues">最小値の配列（null のとき、すべて 0。整数部分6桁＋小数点以下3桁まで）</param>
        /// <param name="maxValues">最大値の配列（null のとき、すべて 100。整数部分6桁＋小数点以下3桁まで）</param>
        /// <param name="digits">値の小数点以下の桁数の配列（0 のとき整数、小数点以下 1～3 桁まで）</param>
        /// <param name="itemsTextColor">アイテムの文字色（0 で指定なし："AARRGGBB"[Android(Java)の形式]）</param>
        /// <param name="callbackGameObject">コールバックするヒエラルキーの GameObject 名</param>
        /// <param name="resultCallbackMethod">「OK」押したときの結果コールバックメソッド名</param>
        /// <param name="changeCallbackMethod">スライダーの値変更コールバックメソッド名</param>
        /// <param name="cancelCallbackMethod">キャンセル時のコールバックメソッド名</param>
        /// <param name="okCaption">「OK」ボタンの文字列</param>
        /// <param name="cancelCaption">「Cancel」ボタンの文字列</param>
        /// <param name="style">スタイル（テーマ："android:Theme.DeviceDefault.Dialog.Alert", "android:Theme.DeviceDefault.Light.Dialog.Alert"等）</param>
        ...
        /// <param name="maxValues">最大値の配列（null のとき、すべて 100。整数部分6桁＋小数点以下3桁まで）</param>
        /// <param name="digits">値の小数点以下の桁数の配列（0 のとき整数、小数点以下 1～3 桁まで）</param>
        /// <param name="itemsTextColor">アイテムの文字色（Color.clear で指定なし[=無色透明ではない]）</param>
        /// <param name="callbackGameObject">コールバックするヒエラルキーの GameObject 名</param>
        /// <param name="resultCallbackMethod">「OK」押したときの結果コールバックメソッド名</param>
        /// <param name="changeCallbackMethod">スライダーの値変更コールバックメソッド名</param>
        /// <param name="cancelCallbackMethod">キャンセル時のコールバックメソッド名</param>
        ...
        ///　CANCEL_DIALOG : Cancel button pressed
        ///　CLOSE_DIALOG : It was closed without "OK" (tap outside the dialog, erase it by pressing the back key etc.)
        ///･The parameter (dialogItems) of each item (Widgets: DivisorItem, TextItem, SwitchItem, CheckItem, SliderItem, ToggleItem) in one array.
        ...
        ///　CANCEL_DIALOG : キャンセルボタンが押された
        ///　CLOSE_DIALOG : 「OK」せずに閉じられた（ダイアログ外をタップ、バックキーを押して消した等）
        ///・各アイテムのパラメタ（DialogItem）は各ウィジェット用のサブクラス（DivisorItem, TextItem, SwitchItem, CheckItem, SliderItem, ToggleItem）を１つの配列で渡す。
        ...
        /// <param name="title">タイトル文字列</param>
        /// <param name="message">メッセージ文字列（空文字("")のとき無し）</param>
        /// <param name="dialogItems">各アイテム（ウィジェット）のパラメタの配列</param>
        /// <param name="callbackGameObject">コールバックするヒエラルキーの GameObject 名</param>
        /// <param name="resultCallbackMethod">「OK」で結果をコールバックするメソッド名</param>
        /// <param name="cancelCallbackMethod">キャンセル時のコールバックするメソッド名</param>
        /// <param name="resultIsJson">true = 戻り値をJSON形式にする / false = キーと値のペア（key=value\n）[※既定値]</param>
        /// <param name="okCaption">「OK」ボタンの文字列</param>
        /// <param name="cancelCaption">「Cancel」ボタンの文字列</param>
        /// <param name="style">スタイル（テーマ："android:Theme.DeviceDefault.Dialog.Alert", "android:Theme.DeviceDefault.Light.Dialog.Alert"等）</param>
        ...
        /// <param name="dialogItems">各アイテム（ウィジェット）のパラメタの配列</param>
        /// <param name="callbackGameObject">コールバックするヒエラルキーの GameObject 名</param>
        /// <param name="callbackMethod">「OK」で結果をコールバックするメソッド名</param>
        /// <param name="resultIsJson">true = 戻り値をJSON形式にする / false = キーと値のペア（key=value\n）[※既定値]</param>
        /// <param name="okCaption">「OK」ボタンの文字列</param>
        /// <param name="cancelCaption">「Cancel」ボタンの文字列</param>
        /// <param name="style">スタイル（テーマ："android:Theme.DeviceDefault.Dialog.Alert", "android:Theme.DeviceDefault.Light.Dialog.Alert"等）</param>
        ...
        /// <param name="title">タイトル文字列</param>
        /// <param name="message">メッセージ文字列</param>
        /// <param name="text">テキスト初期値</param>
        /// <param name="maxLength">文字数制限（0 で制限なし）</param>
        /// <param name="callbackGameObject">コールバックするヒエラルキーの GameObject 名</param>
        /// <param name="callbackMethod">コールバックするメソッド名</param>
        /// <param name="okCaption">「OK」ボタンの文字列</param>
        /// <param name="cancelCaption">「Cancel」ボタンの文字列</param>
        ...
        /// https://developer.android.com/reference/android/R.style.html#Theme
        /// </summary>
        /// <param name="title">タイトル文字列（※メッセージ代わりでも良い）</param>
        /// <param name="text">テキスト初期値</param>
        /// <param name="maxLength">文字数制限（0 で制限なし）</param>
        /// <param name="callbackGameObject">コールバックするヒエラルキーの GameObject 名</param>
        /// <param name="callbackMethod">コールバックするメソッド名</param>
        ...
        /// <param name="maxLength">文字数制限（0 で制限なし）。小数点や符号も含むので注意。</param>
        /// <param name="enableDecimal">true = 少数を入力可能にする / false = 整数のみ</param>
        /// <param name="enableSign">true = 頭に符号（'-' or '+'）を入力可能にする</param>
        /// <param name="callbackGameObject">コールバックするヒエラルキーの GameObject 名</param>
        /// <param name="callbackMethod">コールバックするメソッド名</param>
        /// <param name="okCaption">「OK」ボタンの文字列</param>
        /// <param name="cancelCaption">「Cancel」ボタンの文字列</param>
        ...
        /// <param name="text">テキスト初期値</param>
        /// <param name="maxLength">文字数制限（0 で制限なし）。</param>
        /// <param name="addChars">記号など追加で許可する文字リスト（"_-.@" のように書く[各文字ごとで判定される]、無いとき=空文字("")にする）</param>
        /// <param name="callbackGameObject">コールバックするヒエラルキーの GameObject 名</param>
        /// <param name="callbackMethod">コールバックするメソッド名</param>
        /// <param name="okCaption">「OK」ボタンの文字列</param>
        /// <param name="cancelCaption">「Cancel」ボタンの文字列</param>
        ...
        /// <param name="text">テキスト初期値</param>
        /// <param name="maxLength">文字数制限（0 で制限なし）。</param>
        /// <param name="addChars">記号など追加で許可する文字リスト（"_-.@" のように書く[各文字ごとで判定される]）</param>
        /// <param name="callbackGameObject">コールバックするヒエラルキーの GameObject 名</param>
        /// <param name="callbackMethod">コールバックするメソッド名</param>
        /// <param name="okCaption">「OK」ボタンの文字列</param>
        /// <param name="cancelCaption">「Cancel」ボタンの文字列</param>
        ...
        /// <param name="text">テキスト初期値</param>
        /// <param name="maxLength">文字数制限（0 で制限なし）。</param>
        /// <param name="numberOnly">true = 数字のみのパスワード / false = 半角英数記号のパスワード</param>
        /// <param name="callbackGameObject">コールバックするヒエラルキーの GameObject 名</param>
        /// <param name="callbackMethod">コールバックするメソッド名</param>
        /// <param name="okCaption">「OK」ボタンの文字列</param>
        /// <param name="cancelCaption">「Cancel」ボタンの文字列</param>
        ...
        /// https://developer.android.com/reference/android/R.style.html#Theme
        /// </summary>
        /// <param name="defaultDate">日付初期値（"2017/01/31", "17/1/1" のようなフォーマット [年：4桁 or 2桁 / 月：1～2桁 / 日：1～2桁]</param>
        /// <param name="resultDateFormat">戻り値の日付フォーマット（デフォルトで "yyyy/MM/dd"→"2017/01/03"）[例："yy-M-d"→"17-1-3", "y年M月d日"→"17年1月3日"]</param>
        /// <param name="callbackGameObject">コールバックするヒエラルキーの GameObject 名</param>
        /// <param name="callbackMethod">コールバックするメソッド名</param>
        /// <param name="style">スタイル（テーマ："android:Theme.DeviceDefault.Dialog.Alert", "android:Theme.DeviceDefault.Light.Dialog.Alert"等）</param>
        ...
        /// https://developer.android.com/reference/android/R.style.html#Theme
        /// </summary>
        /// <param name="defaultTime">時刻初期値（24時間表記："0:00"～"23:59"）[時：1～2桁/分：1～2桁]</param>
        /// <param name="resultTimeFormat">戻り値の時刻のフォーマット（デフォルトで "HH:mm"→"03:05"）[例："H:mm"→"3:05", "H時m分"→"3時5分"]</param>
        /// <param name="callbackGameObject">コールバックするヒエラルキーの GameObject 名</param>
        /// <param name="callbackMethod">コールバックするメソッド名</param>
        /// <param name="style">スタイル（テーマ："android:Theme.DeviceDefault.Dialog.Alert", "android:Theme.DeviceDefault.Light.Dialog.Alert"等）</param>
        ...
        /// <param name="title">タイトル文字列</param>
        /// <param name="message">メッセージ文字列</param>
        /// <param name="iconName">アイコンリソース名（Unity はデフォで "app_icon"）</param>
        /// <param name="tag">識別タグ（連続で通知したとき、同じタグは上書きで表示される）</param>
        /// <param name="showTimestamp">通知時刻を表示する</param>
        /// <param name="vibratorPattern">バイブレーターのパターン配列 / null = 無し</param>
        ...
        /// <param name="tag">識別タグ（連続で通知したとき、同じタグは上書きで表示される）</param>
        /// <param name="showTimestamp">通知時刻を表示する</param>
        /// <param name="vibratorDuration">バイブレーター（振動）の長さ（単位：ms[ミリセカンド=1/1000秒]）/ 0 以下で無し</param>
        public static void ShowNotification(string title, string message, string iconName, string tag,
        ...
        /// <param name="iconName">アイコンリソース名（Unity はデフォで "app_icon"）</param>
        /// <param name="tag">識別タグ（連続で通知したとき、同じタグは上書きで表示される）</param>
        /// <param name="action">アクション文字列（"android.intent.action.VIEW" など）</param>
        /// <param name="uri">アクションに渡すURI（URLなど）</param>
        /// <param name="showTimestamp">通知時刻を表示する</param>
        /// <param name="vibratorPattern">バイブレーターのパターン配列 / null = 無し</param>
        ...
        /// <param name="tag">識別タグ（連続で通知したとき、同じタグは上書きで表示される）</param>
        /// <param name="showTimestamp">通知時刻を表示する</param>
        /// <param name="vibratorPattern">バイブレーターのパターン配列（off, on, off, on,... の順に長さを入れる（単位：ms[ミリセカンド=1/1000秒]））/ null = 無し</param>
        ...
        /// </summary>
        /// <param name="pattern">長さのパターン配列</param>
        /// <param name="isLoop">true = ループする</param>
        ...
        /// バイブレーターを１度だけ振動させる。
        /// </summary>
        /// <param name="duration">振動の長さ（単位：ms[ミリセカンド=1/1000秒]）</param>
        ...
        /// https://developer.android.com/reference/android/provider/Settings.html#ACTION_ACCESSIBILITY_SETTINGS
        /// </summary>
        /// <param name="action">起動するアクション（"android.settings.SETTINGS" など）</param>
        ...
        /// https://developer.android.com/reference/android/provider/Settings.html#ACTION_ACCESSIBILITY_SETTINGS
        /// </summary>
        /// <param name="action">起動するアクション（"android.intent.action.WEB_SEARCH" など）</param>
        /// <param name="extra">アクションに渡すデータ名（キー）（"query" など）</param>
        /// <param name="query">アクションに渡すクエリ（値）</param>
        ...
        /// https://developer.android.com/reference/android/provider/Settings.html#ACTION_ACCESSIBILITY_SETTINGS
        /// </summary>
        /// <param name="action">起動するアクション（"android.intent.action.SEND" など）</param>
        /// <param name="extra">アクションに渡すデータ名（キー）（"android.intent.extra.TEXT" など）</param>
        /// <param name="query">アクションに渡すクエリ（値）</param>
        /// <param name="mimetype">MIME Type（"text/plain" など）</param>
        ...
        /// </summary>
        /// <param name="action">アクション文字列（"android.intent.action.SEND" など）</param>
        /// <param name="extra">アクションに渡すデータ名（キー）（"android.intent.extra.TEXT" など）</param>
        /// <param name="query">アクションに渡すクエリ（値）</param>
        /// <param name="mimetype">MIME Type（"text/plain" など）</param>
        /// <param name="title">Chooser に表示するタイトル（省略="Select an application"）</param>
        ...
        /// 
        ///(例)
        /// StartActionURI("android.intent.action.VIEW", "geo:37.7749,-122.4194?q=restaurants");   //マップ（検索:restaurants）
        /// StartActionURI("android.intent.action.VIEW", "google.streetview:cbll=29.9774614,31.1329645&cbp=0,30,0,0,-15");   //ストリートビュー
        /// StartActionURI("android.intent.action.SENDTO", "mailto:xxx@example.com");   //メーラー起動
        ...
        /// <param name="action">アクション文字列（"android.intent.action.VIEW" など）</param>
        /// <param name="uri">アクションに渡すURI（URLなど）</param>
        /// <param name="mimeType">MIME type ("application/pdf" など)</param>
        ...
        /// </summary>
        /// <param name="text">送信するテキスト</param>
        /// <param name="attachmentURI">添付ファイルの URI（"content://～"）</param>
        ...
        /// </summary>
        /// <param name="packageName">パッケージ名（Application ID）</param>
        ...
        /// </summary>
        /// <param name="path">対象パス（絶対パス）</param>
        /// <param name="callbackGameObject">完了をコールバックするヒエラルキーの GameObject 名</param>
        /// <param name="completeCallbackMethod">完了をコールバックするメソッド名</param>
        /// <param name="resultIsJson">true = 戻り値をJSON形式にする / false = パス名 [※既定値]</param>
        ...
        ///・完了コールバックはパスごとに送られる。
        /// </summary>
        /// <param name="paths">対象パス（絶対パス）の配列</param>
        /// <param name="callbackGameObject">完了をコールバックするヒエラルキーの GameObject 名</param>
        /// <param name="completeCallbackMethod">完了をコールバックするメソッド名</param>
        /// <param name="resultIsJson">true = 戻り値をJSON形式にする / false = パス名 [※既定値]</param>
        ...
        /// 仮想ストレージが存在するか？
        /// </summary>
        /// <returns>true = 仮想ストレージが存在する</returns>
        ...
        /// </summary>
        /// <returns>true = 脱着できる（SDカードのように）</returns>
        ...
        /// </summary>
        /// <returns>true = マウントされている</returns>
        ...
        /// </summary>
        /// <returns>true = ReadOnly でマウントされている</returns>
        ...
        /// </summary>
        /// <returns>true = 読み書き属性でマウントされている</returns>
        ...
        /// </summary>
        /// <returns>"unknown", "removed", "unmounted", "checking", "nofs", "mounted", "mounted_ro", "shared", "bad_removal", or "unmountable" のいずれか</returns>
        ...
        /// </summary>
        /// <returns>"/storage/emulated/0" のようなディレクトリ名</returns>
        ...
        /// </summary>
        /// <returns>"/storage/emulated/0/Alarms" のようなディレクトリ名</returns>
        ...
        /// </summary>
        /// <returns>"/storage/emulated/0/DCIM" のようなディレクトリ名</returns>
        ...
        /// </summary>
        /// <returns>"/storage/emulated/0/Documents" のようなディレクトリ名</returns>
        ...
        /// </summary>
        /// <returns>"/storage/emulated/0/Downloads" のようなディレクトリ名</returns>
        ...
        /// </summary>
        /// <returns>"/storage/emulated/0/Movies" のようなディレクトリ名</returns>
        ...
        /// </summary>
        /// <returns>"/storage/emulated/0/Music" のようなディレクトリ名</returns>
        ...
        /// </summary>
        /// <returns>"/storage/emulated/0/Notifications" のようなディレクトリ名</returns>
        ...
        /// </summary>
        /// <returns>"/storage/emulated/0/Pictures" のようなディレクトリ名</returns>
        ...
        /// </summary>
        /// <returns>"/storage/emulated/0/Podcasts" のようなディレクトリ名</returns>
        ...
        /// </summary>
        /// <returns>"/storage/emulated/0/Ringtones" のようなディレクトリ名</returns>
        ...
        /// http://fantom1x.blog130.fc2.com/blog-entry-295.html
        /// </summary>
        /// <param name="locale">言語設定（例： "ja", "en", "en_GB" 等）</param>
        /// <param name="callbackGameObject">コールバックするヒエラルキーの GameObject 名</param>
        /// <param name="resultCallbackMethod">結果を受け取るコールバックメソッド名</param>
        /// <param name="message">メッセージ文字列</param>
        ...
        /// <param name="locale">言語設定（例： "ja", "en", "en_GB" 等）</param>
        /// <param name="callbackGameObject">コールバックするヒエラルキーの GameObject 名</param>
        /// <param name="resultCallbackMethod">認識成功したとき、改行区切りで文字列を返すコールバックメソッド名</param>
        /// <param name="errorCallbackMethod">認識失敗またはエラーのとき、エラーコード（文字列）を返すコールバックメソッド名</param>
        /// <param name="readyCallbackMethod">音声認識の待機待ち開始のコールバックメソッド名（必ず"onReadyForSpeech"が返る）</param>
        /// <param name="beginCallbackMethod">認識開始（はじめの音声がマイクに入った）のときのコールバックメソッド名（必ず"onBeginningOfSpeech"が返る）</param>
        ...
        /// <param name="locale">言語設定（例： "ja", "en", "en_GB" 等）</param>
        /// <param name="callbackGameObject">コールバックするヒエラルキーの GameObject 名</param>
        /// <param name="statusCallbackMethod">ステータス（エラーを含む）を返すコールバックメソッド名</param>
        ...
        /// http://fantom1x.blog130.fc2.com/blog-entry-295.html
        /// </summary>
        /// <param name="message">読み上げるテキスト</param>
        /// <param name="locale">言語設定（例： "ja", "en" 等）</param>
        /// <param name="callbackGameObject">コールバックするヒエラルキーの GameObject 名</param>
        /// <param name="statusCallbackMethod">ステータス（エラーを含む）を返すコールバックメソッド名</param>
        /// <param name="startCallbackMethod">読み上げ開始をコールバックするメソッド名（必ず "onStart" の文字列が返る）</param>
        /// <param name="doneCallbackMethod">読み上げ終了をコールバックするメソッド名（必ず "onDone" の文字列が返る）</param>
        /// <param name="stopCallbackMethod">読み上げ中断をコールバックするメソッド名（再生途中は"INTERRUPTED"。それ以外は "onStop" の文字列が返る）[API23(Android6.0)以上]</param>
        ...
        /// <returns>設定後の速度：0.5f～1.0f～2.0f</returns>
        ...
        /// <returns>加減後の速度：0.5f～1.0f～2.0f</returns>
        ...
        /// <returns>設定後の音程：0.5f～1.0f～2.0f</returns>
        ...
        /// </summary>
        /// <param name="addPitch">0.5f～1.0f～2.0f</param>
        /// <returns>加減後の音程：0.5f～1.0f～2.0f</returns>
        ...
        //※各センサーの搭載は端末の種類によって違うので注意。Google Play などには利用できるセンサーでフィルタリングした方が良い。
        // (Using Google Play filters to target specific sensor configurations)
        //  https://developer.android.com/guide/topics/sensors/sensors_overview.html#sensors-configs
        ...
        //※コールバックの登録は各センサーごとに唯一となる（常に上書き。最後に登録したものが有効となる）。
        //※アプリケーションの Pause → Resume での削除→再登録は不要（自動的に停止→再開される）。
        // (※「AndroidManifest-FullPlugin_～.xml」をリネームして使う)
        //========================================================================
        ...
        /// 各センサーのサポートを取得
        /// </summary>
        /// <param name="sensorType">センサー種類定数</param>
        /// <returns>true = サポートされている</returns>
        ...
        /// </summary>
        /// <param name="sensorType">センサー種類定数</param>
        /// <param name="sensorDelay">センサー速度定数</param>
        /// <param name="callbackGameObject">コールバックするヒエラルキーの GameObject 名</param>
        /// <param name="callbackMethod">コールバックするメソッド名</param>
        ...
        /// <param name="callbackGameObject">コールバックするヒエラルキーの GameObject 名</param>
        /// <param name="callbackMethod">コールバックするメソッド名</param>
        /// <param name="sessionID">ユニークセッションを判別する文字列</param>
        /// <param name="title">タイトル文字列（空文字でデバイスのデフォルト）</param>
        /// <param name="message">メッセージ文字列（空文字でデバイスのデフォルト）</param>
        ...
        /// <param name="showUI">true = UIを表示する</param>
        /// <returns>設定後の音量</returns>
        ...
        ///・0～max (max:15?：システムによるかも)
        /// </summary>
        /// <param name="addVol">変化（加算）させる音量</param>
        /// <param name="showUI">true = UIを表示する</param>
        /// <returns>変化（加算）後の音量</returns>
        ...
        public static class HardKey
        {
            ...
            private static AndroidJavaClass mAndroidHardKey;    //キャッシュ
            ...
            /// </summary>
            /// <param name="callbackGameObject">コールバックするヒエラルキーの GameObject 名</param>
            /// <param name="callbackMethod">コールバックするメソッド</param>
            /// <param name="resultValue">音量上げたときの戻値</param>
            ...
            /// <param name="callbackGameObject">コールバックするヒエラルキーの GameObject 名</param>
            /// <param name="callbackMethod">コールバックするメソッド</param>
            /// <param name="resultValue">音量下げたときの戻値</param>
            ...
            /// </summary>
            /// <param name="enable">true = 端末で音量操作可能/false = 端末での音量操作を無効化</param>
    ...
    {
        public string text = "";        //テキスト文字列
        public int textColor = 0;       //文字色（0:指定なし）
        public int backgroundColor = 0; //背景色（0:指定なし）
        public string align = "";       //文字揃え（"": 指定なし, "center", "right", "left" のいずれか）
    ...
    {
        public string text = "";        //テキスト文字列
        public bool defChecked;         //初期オン・オフ
        public int textColor = 0;       //0:指定なし
        public string changeCallbackMethod = ""; //リアルタイムにスイッチを押したときのコールバックメソッド名。「OK」のときの結果とは別に送信される（戻り値は "key=value" のみ）。
    ...
    {
        public string text = "";        //テキスト文字列
        public float value;             //初期値
        public float min;               //取り得る最小値
        public float max;               //取り得る最大値
        public int digit;               //小数点以下桁数（0:整数, 1～3:小数点以下桁数）
        public int textColor = 0;       //文字色（0:指定なし）
        public string changeCallbackMethod = ""; //リアルタイムにスライダーで値を変化させたときのコールバックメソッド名。「OK」のときの結果とは別に送信される（戻り値は "key=value" のみ）。
    ...
    {
        public string[] items;          //選択肢テキスト
        public string[] values;         //各選択肢に対する値。（文字列）戻り値になる。
        public string defValue = "";    //デフォルトの値（※checkedItem より優先）
        public int checkedItem;         //デフォルトのインデクス（※defValueが未設定 or 見つからないとき反映）
        public int textColor = 0;       //文字色（0:指定なし）
        public string changeCallbackMethod = ""; //リアルタイムにトグルボタンを押したときのコールバックメソッド名。「OK」のときの結果とは別に送信される（戻り値は "key=value" のみ）。
    ...
    public enum SensorType
    {
        ...
        Accelerometer = 1,                  //加速度 [m/s^2]（≒ Input.acceleration * -10）
        MagneticField = 2,                  //磁気 [uT]      (= Input.compass.rawVector)
        Orientation = 3,                    //方向 [度] (※API 20 で廃止）
        Gyroscope = 4,                      //角速度 [rad/s]
        Light = 5,                          //照度 [lux]
        Pressure = 6,                       //気圧 [hPa]  
        Proximity = 8,                      //近接 [cm]
        Gravity = 9,                        //重力 [m/s^2]
        LinearAcceleration = 10,            //線形加速度 [m/s^2]（= Accelerometer - Gravity）
        RotationVector = 11,                //デバイスの回転ベクトル（※[0]~[2]:API 9, [3][4]:API 18 以上）
        RelativeHumidity = 12,              //湿度 [%]（※API 20 以上）
        AmbientTemperature = 13,            //気温 [℃]
        MagneticFieldUncalibrated = 14,     //未較正の磁気 [uT]（※API 18 以上）
        GameRotationVector = 15,            //地磁気を使用しない回転ベクトル（※API 18 以上）
        GyroscopeUncalibrated = 16,         //未較正の角速度 [rad/s]（※API 18 以上）
        SignificantMotion = 17,             //動作継続トリガ（※API 18 以上）
        StepDetector = 18,                  //歩行トリガ [1のみ]（※API 19 以上）
        StepCounter = 19,                   //歩数 [通算歩数]（※API 19 以上）
        GeomagneticRotationVector = 20,     //地磁気の回転ベクトル（※API 19 以上）
        HeartRate = 21,                     //毎分の心拍数 [bpm]（※API 20 以上。パーミッションが必要：'android.permission.BODY_SENSORS'）
        Pose6DOF = 28,                      //デバイスポーズ（※API 24 以上）
        StationaryDetect = 29,              //静止検出トリガ [1のみ]（※API 24 以上）
        MotionDetect = 30,                  //動作検出トリガ [1のみ]（※API 24 以上）
        HeartBeat = 31,                     //心拍ピーク検出 [confidence=0~1]（※API 24 以上）
        LowLatencyOffbodyDetect = 34,       //デバイス装着検出 [0 (device is off-body) or 1 (device is on-body)]（※API 26 以上）
        AccelerometerUncalibrated = 35,     //未較正の加速度（※API 26 以上）
    }
